 ...
 * Logo "On The Corner" — SVG inline scalabile. Bandierina d'angolo
 * stilizzata, colore #e8c800 su sfondo neutro/trasparente.
 *
 * Props:
 *   - withWordmark: mostra il testo "ON THE CORNER" sotto/accanto
    ...
    <span className={`inline-flex items-center gap-2 ${className ?? ''}`}>
      ...
      >
        ...
        <path
          ...
          fill="none"
        />
        {/* asta della bandierina */}
        <line x1="42" y1="22" x2="42" y2="56" stroke="#e8c800" strokeWidth="3.5" strokeLinecap="round" />
        {/* bandiera triangolare con leggera dinamica */}
        <path
          d="M 42 22 L 60 26 L 42 34 Z"
          fill="#e8c800"
        />
        {/* base del campo (linea orizzontale) */}
        <line x1="6" y1="58" x2="58" y2="58" stroke="#e8c800" strokeWidth="2" strokeLinecap="round" opacity="0.4" />
      </svg>

      {withWordmark && (
        <span
          className="font-[var(--font-archivo-black)] uppercase tracking-tight text-white"
