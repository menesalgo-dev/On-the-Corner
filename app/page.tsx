    ...
    <>
      ...
      <main className="mx-auto max-w-[1100px] px-4 pb-24 pt-4 sm:px-6 sm:pb-12 sm:pt-6">
        <header className="mb-5">
          <p className="text-[10px] uppercase tracking-widest text-[#e8c800]" style={{ fontFamily: 'var(--font-dm-mono)' }}>
            Ciao, oggi su On The Corner ⚽
          </p>
          <h1 className="mt-1 text-2xl uppercase tracking-tight text-white sm:text-3xl" style={{ fontFamily: 'var(--font-archivo-black)' }}>
        ...
        {counts.today_scheduled > 0 && liveMatches.length === 0 && (
          <Link href="/live" className="mb-6 flex items-center justify-between rounded-2xl border border-[#e8c800]/30 bg-gradient-to-r from-[#0d0d0d] to-[#1a1500] p-4 transition hover:scale-[1.01]">
            <div className="flex items-center gap-3">
              <Radio className="h-5 w-5 text-[#e8c800]" />
              <div>
                <p className="text-sm uppercase tracking-tight text-[#e8c800]" style={{ fontFamily: 'var(--font-archivo-black)' }}>
        ...
        {evidenza.length > 0 && (
          <section className="mb-6">
            <header className="mb-3 flex items-baseline justify-between">
              <h2 className="text-sm uppercase tracking-tight text-white" style={{ fontFamily: 'var(--font-archivo-black)' }}>
                In evidenza
              </h2>
              <Link href="/news" className="inline-flex items-center gap-1 text-[10px] uppercase tracking-widest text-zinc-500 transition hover:text-[#e8c800]" style={{ fontFamily: 'var(--font-dm-mono)' }}>
        ...
        <Link href="/news" className="flex items-center justify-between rounded-2xl border border-[#1f1f1f] bg-[#0d0d0d] p-4 transition hover:border-[#e8c800]/40">
          <div className="flex items-center gap-3">
            <Newspaper className="h-5 w-5 text-zinc-400" />
            <div>
              <p className="text-sm text-white">Cerchi una notizia?</p>
              <p className="text-xs text-zinc-500">Apri l&apos;archivio con filtri per categoria, fonte e data</p>
            </div>
          </div>
